    ...
    <div class="flex justify-center">
        <div class="w-full max-w-7xl space-y-6">
            ...
            <div class="flex flex-col sm:flex-row justify-between items-center gap-4 bg-white dark:bg-gray-900 p-2 rounded-xl shadow-sm border border-gray-200 dark:border-gray-800 sticky top-4 z-10 backdrop-blur-sm bg-opacity-90">
                ...
                {{-- A. View Toggle --}}
                <div class="dark:bg-gray-800 p-1.5 rounded-lg flex items-center w-full sm:w-auto">
                    <button
                        ...
                        {{ $activeView === 'table'
                            ? 'text-black dark:text-black shadow-sm ring-1 ring-gray-200 dark:ring-gray-600'
                    ...
                    <button
                        ...
                        class="flex-1 sm:flex-none px-4 py-2 text-sm font-medium rounded-md transition-all duration-200 flex items-center justify-center gap-2
                        {{ $activeView === 'chart'
                            ? 'text-primary-600 shadow-sm ring-1 ring-gray-200 dark:bg-gray-700 dark:ring-gray-600'
            ...
            {{-- VIEW B: CHART --}}
            @if ($activeView === 'chart')
                {{-- Fixed Container with Proper Background --}}
